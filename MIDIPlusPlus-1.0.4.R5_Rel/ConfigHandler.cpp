...
namespace midi {
    ...
    void to_json(json& j, const PlaybackSettings& p) {
        j = json{
            ...
            {"REPEATED_NOTE_GAP_MS", p.REPEATED_NOTE_GAP_MS},
    ...
    void to_json(json& j, const Config& c) {
        j = json{
            ...
            {"REPEATED_NOTE_GAP_MS", c.playback.REPEATED_NOTE_GAP_MS},
            {"CUSTOM_VELOCITY_CURVES", json::array()},
    ...
    void from_json(const json& j, Config& c) {
        ...
        // Optional for backward compatibility with older config files.
